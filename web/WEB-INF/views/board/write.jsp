...
<!--기본설정 (iboard가 null로 들어가서 에러터짐 그래서 기본값 0을 줌)-->
...
<!--글쓰기 했고 수정할 때 (data가 있고 && iboard가 존재할 때) 설정-->
...
<div>
    ...
    <form action="${actionVal}" method="post">
        ...
        <input type="hidden" name="iboard" value="${iboardVal}"> <!--수정때만 사용-->
        <input type="hidden" name="icategory" value="${icategoryVal}"> <!--등록때만 사용?-->
